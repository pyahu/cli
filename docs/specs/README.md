...
- [Redis service, Kafka Connect plugins, and deferred connectors](redis-and-connect-plugins-v1.md) (v0.6.x)
...
v0.6.x adds Redis (Valkey), declarative Kafka Connect plugins, and deferred
